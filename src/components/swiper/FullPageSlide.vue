<template>
  <div class="creative-slider-container h-full w-full overflow-hidden surface-ground">
    <swiper
      ...
      :coverflowEffect="effect === 'coverflow' ? coverflowEffectOptions : undefined"
...
.health-info-slide-content {
  position: relative; /* Crucial for absolute positioning of foreground-image */
}
...
.foreground-image {
  ...
  top: 0; /* Add top and left to ensure it covers the space before object-position kicks in */
  left: 0;
}
